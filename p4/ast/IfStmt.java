...
public class IfStmt extends Stmt {
	...
	public void execute() {
		if (elsestmt != null) {
			...
			HashMap<String, AbstractValue> s1 = new HashMap<String, AbstractValue>(table.getOriginalState());
			thenstmt.execute();
			HashMap<String, AbstractValue> s2 = new HashMap<String, AbstractValue>(table.getOriginalState());
			table.mergeState(s1, s2);
